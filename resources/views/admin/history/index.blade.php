...
<div style="margin-bottom:20px;">
    <form method="GET" style="display:flex;gap:10px;align-items:flex-end;flex-wrap:wrap;">
        <div>
            ...
            <input type="text" name="container_number" value="{{ request('container_number') }}"
...
<div class="card">
    ...
    <div class="table-wrap">
        <table>
            <thead>
                <tr>
                    <th>#</th><th>Booking ID</th><th>អតិថិជន</th>
                    <th>ប្រភេទ</th><th>លេខកុងតឺន័រ</th><th>ផ្លូវដឹក</th>
                    <th>តម្លៃសរុប</th><th>ថ្ងៃបញ្ចប់</th>
                </tr>
            </thead>
            <tbody>
