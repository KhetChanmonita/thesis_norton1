...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .dt-container { max-width: 1100px; margin: 0 auto; padding: 0 24px; }
        ...
        .dt-breadcrumb a { color: #fff; text-decoration: none; }
        ...
        .dt-hero h1 span { color: #ffe0b2; }

        .dt-hero p {
            font-size: 1.05rem; line-height: 1.75;
            opacity: 0.92; max-width: 680px; margin-bottom: 28px;
        }
        ...
        .dt-hero-stat .val { font-size: 1.5rem; font-weight: 700; display: block; }
        .dt-hero-stat .lbl { font-size: 0.78rem; opacity: 0.85; }

        /* ── Main Content ── */
        .dt-body { padding: 60px 0; }
        ...
        .dt-card-header i { font-size: 20px; }
        .dt-card-header h2 { font-size: 1.05rem; font-weight: 700; margin: 0; }
        .dt-card-body { padding: 24px; }
        .dt-card-body p {
            line-height: 1.85; color: #555; font-size: 0.95rem;
            margin-bottom: 14px;
        }
        .dt-card-body p:last-child { margin-bottom: 0; }

        /* Process Steps */
        .dt-steps { counter-reset: step; }
        .dt-step {
        ...
        .dt-step-content p { font-size: 0.88rem; color: #666; line-height: 1.65; }

        /* Features List */
        .dt-features { list-style: none; }
        .dt-features li {
            display: flex; align-items: flex-start; gap: 12px;
            padding: 11px 0; border-bottom: 1px solid #f5f5f5;
            font-size: 0.9rem; color: #444; line-height: 1.6;
        }
        .dt-features li:last-child { border-bottom: none; }
        .dt-features li i { color: #FF6B00; margin-top: 3px; flex-shrink: 0; }

        /* Documents */
        .dt-docs { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }
        .dt-doc {
            background: #fff8f3; border: 1px solid #ffe0c4;
            border-radius: 10px; padding: 12px 14px;
            display: flex; align-items: center; gap: 10px;
            font-size: 0.85rem; color: #444; font-weight: 500;
        }
        .dt-doc i { color: #FF6B00; font-size: 16px; flex-shrink: 0; }
        ...
        .dt-sidebar-body { padding: 18px 20px; }
        ...
        .dt-info-row .lbl { color: #888; }
        .dt-info-row .val { font-weight: 700; color: #222; }
        .dt-info-row .val.orange { color: #FF6B00; }
        ...
        .dt-cta-card i { font-size: 40px; opacity: 0.85; margin-bottom: 12px; }
        .dt-cta-card h3 { font-size: 1.1rem; font-weight: 700; margin-bottom: 8px; }
        .dt-cta-card p { font-size: 0.85rem; opacity: 0.9; margin-bottom: 20px; line-height: 1.6; }
        .dt-cta-btn {
        ...
        .dt-cta-btn.primary:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(0,0,0,0.2); }
        .dt-cta-btn.secondary {
            background: rgba(255,255,255,0.2);
            color: #fff; border: 2px solid rgba(255,255,255,0.5);
        }
        .dt-cta-btn.secondary:hover { background: rgba(255,255,255,0.3); }

        /* Responsive */
        @media (max-width: 900px) {
            .dt-grid { grid-template-columns: 1fr; }
            .dt-docs { grid-template-columns: 1fr; }
            .dt-hero { padding: 100px 0 50px; }
        }
    </style>
</head>
<body>
...
$services = [
    'import-shv' => [
        ...
        'steps' => [
            ...
            ['num'=>'06','title'=>'ការដឹកបានបញ្ចប់','desc'=>'ផ្ញើរបាយការណ៍ Delivery Confirmation និងរូបថត POD'],
        ],
        'features' => [
    ...
    'import-pp' => [
        ...
        'steps' => [
            ...
            ['num'=>'06','title'=>'Delivery Completed','desc'=>'ផ្ញើ POD ជូន និង Empty Return Container'],
        ],
        'features' => [
